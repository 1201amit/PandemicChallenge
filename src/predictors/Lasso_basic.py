...
class XPrizePredictor(object):
    ...
    def _construct_model(self, nb_context, nb_action, nb_lookback_days=10):
        ...
        ####################
        ### This is where we add our model. I have given an skeleton of the code for the MLP. You can followthis Sequential structure else do the other more general 
        #format. The choice is upto you.
        ##########################
        NN_model = Sequential()
...
# The Input Layer:
        ...
        NN_model.summary()
        ######
        #This is a basic code. Please change the compile function according to the rest of the code flow.
        #####################################
